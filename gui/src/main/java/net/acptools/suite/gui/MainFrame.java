...
public class MainFrame extends JFrame {
    ...
    /**
     * Text field with path to xml file with project description (configuration).
     */
    ...
    private void initializeComponents() {
        ...
        projectSettingsPanel
                .setBorder(new TitledBorder(null, "Project", TitledBorder.LEADING, TitledBorder.TOP, null, null));
     ...
     * @return true, if the path represents an existing directory, false otherwise.
     */
    ...
    private void setButtons() {
        ...
        if (!canBuild) {
            projectXmlChangeButton.setEnabled(false);
        }
     ...
     * Builds the project.
     *
     * @param clean true, if the output directory should be cleaned before the build
