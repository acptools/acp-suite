...
import net.acptools.suite.generator.compilation.CompilationSettings.LooperStrategy;
...
import net.acptools.suite.generator.project.EepromItem;
...
public class ACPProjectCodeGenerator extends ACPContentGenerator {
     ...
     *
     * @param valueOrProperty the string to be converted.
     * @param component       the component for which the conversion is realized.
     * @param componentType   the type of component for which the conversion is realized.
     * @param unsetValue      the value to return if the property is not set or is an empty
     *                        string.
