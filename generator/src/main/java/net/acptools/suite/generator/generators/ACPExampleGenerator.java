...
import net.acptools.suite.generator.models.modules.*;
import net.acptools.suite.generator.models.project.*;
...
public class ACPExampleGenerator extends ACPContentGenerator {
     ...
     * @param callbackCodeLines  the list with code lines.
     */
     ...
     *
     * @param compilationContext   the compilation context.
     * @param publicObjectsSummary the list with code lines.
     */
