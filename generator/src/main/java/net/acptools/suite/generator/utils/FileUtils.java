...
public class FileUtils {
     ...
     *
     * @param file         the file with template.
     * @param replacements the replacement to be applied.
     ...
     * Loads template file and applies specified replacements.
     *
     * @param resource     the path to a resource with template
     * @param replacements the replacement to be applied.
     ...
     *
     * @param templateContent the string containing a template definition.
     ...
     *
     * @param lines      the lines to be merged.
     * @param linePrefix the prefix to be added at the beginning of each line.
     * @return merged lines.
     */
