...
public abstract class ACPContentGenerator {
     ...
     * generator.
     *
     * @param dependency the content generator to be executed before this content
     *                   generator.
     */
     ...
     * Prepares the output.
     *
     * @param compilationContext the compilation (content generation) context.
     * @param output             the map storing output of content generation.
     */
     ...
     * replacements.
     *
     * @param templateName the name of template resource.
     * @param replacements the map with replacements.
     ...
     * content generators.
     *
     * @param contentGenerators  the list of content generators.
     * @param compilationContext the compilaton context.
     */
     ...
     *
     * @param cg                the content generator to be processed.
     * @param orderedGenerators the ordered list of content generators.
     * @param lockedGenerators  the locked content generators used to check circular
     *                          dependencies.
     */
