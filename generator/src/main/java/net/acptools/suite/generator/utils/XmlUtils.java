package net.acptools.suite.generator.utils;
...
public final class XmlUtils {
     ...
     *
     * @param element the inspected xml element.
     ...
     *
     * @param element   the element whose child elements are considered.
     * @param childName the desired name of retrieved child elements.
     ...
     *
     * @param element   the element whose child elements are considered.
     * @param childName the desired name of retrieved child element.
     ...
     *
     * @param propElement  the element containing property elements.
     * @param propertyName the name of property.
     * @param defaultValue the returned value, if the property with given name is not
     *                     found.
