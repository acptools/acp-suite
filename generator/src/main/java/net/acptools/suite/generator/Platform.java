...
public abstract class Platform {
     ...
     *
     * @param datatype the name of data type
     ...
     *
     * @param datatype    the name of data type
     * @param offset      the offset of data item in EEPROM
     * @param cached      true, if the wrapper is a caching wrapper.
     * @param arrayLength the number of items (of given datatype) forming the variable.
