...
public class Instance {
    ...
    public class Method {
         ...
         * @param platform        target hardware and compilation platform.
     ...
     *
     * @param componentType the description of the component type.
     */
     ...
     *
     * @param xmlElement     the argument container.
     * @param argElementName the name of element containing an argument definition
     * @param result         the list to which arguments are passed
     * @param argTypeLabel   the label for arguments (used to generate messages of
     *                       exceptions)
     */
     ...
     *
     * @param xmlElement the xml element containg method description
