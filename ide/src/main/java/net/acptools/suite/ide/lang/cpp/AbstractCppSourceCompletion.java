...
public abstract class AbstractCppSourceCompletion extends BasicCompletion
        implements CppSourceCompletion {


    public AbstractCppSourceCompletion(CompletionProvider provider,
