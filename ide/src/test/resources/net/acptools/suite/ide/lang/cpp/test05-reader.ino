...
// Type of active card
CardType::ABS cardType = 1;
CardType::ABS::CDFsf cardType1 = 1;
CardType cardType2 = 1;
...
void sendSimpleCommandResponse(long messageTag, bool success) {
   ...
   //response[0] = success == true ? ReaderMsgCode::COMMAND_OK : ReaderMsgCode::COMMAND_FAILED;
